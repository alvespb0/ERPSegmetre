            ...
            <div class="p-2 flex flex-col lg:flex-row items-center gap-2">
                ...
                <div class="flex flex-wrap items-center gap-2 w-full lg:w-auto">
                    ...
                    >
                        ...
                        <span wire:loading.flex wire:target="getValorizacoes" class="items-center gap-2">
                            <svg class="animate-spin w-4 h-4 text-gray-600 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
