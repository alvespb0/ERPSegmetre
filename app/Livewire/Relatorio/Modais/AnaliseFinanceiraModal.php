...
class AnaliseFinanceiraModal extends Component
{
    ...
    public bool $incluirMargens = true;

    public bool $incluirComposicao = true;

    public bool $incluirEvolucao = true;

    public bool $incluirLiquidez = false;

    public string $visao = 'consolidado';
    ...
    {
        $this->dispatch('fechar-modal-analise-financeira');
    }
    ...
    {
        return view('livewire.relatorio.modais.analise-financeira-modal');
    }
}
