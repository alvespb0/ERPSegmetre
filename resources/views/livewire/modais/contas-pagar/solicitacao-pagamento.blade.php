                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-center flex justify-center gap-2">
                                                ...
                                                @if($solicitacao->comprovante_path)
                                                    <button
                                                        type="button"
                                                        wire:click="downloadComprovante('{{ $solicitacao->comprovante_path }}')"
                                                        wire:loading.attr="disabled"
                                                        wire:target="downloadComprovante"
                                                        class="text-gray-400 hover:text-green-600 p-1 rounded hover:bg-green-50 disabled:opacity-50 disabled:cursor-not-allowed"
