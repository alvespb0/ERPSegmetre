<div
    ...
    role="dialog"
    aria-modal="true"
    aria-labelledby="despesas-modal-titulo"
>
    <div
        ...
        >
            <header class="flex shrink-0 items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 sm:px-6">
                <div>
                    ...
                    <h2 id="despesas-modal-titulo" class="text-lg font-semibold text-gray-900">Despesas — filtros de geração</h2>
                    <p class="mt-1 text-sm text-gray-500">Defina o período e como detalhar pagamentos e despesas. A exportação será conectada na próxima etapa.</p>
                </div>
                <button
                    type="button"
                    wire:click="fechar"
                ...
                <div class="space-y-6">
                    <section class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="dp-inicio" class="block text-xs font-medium text-gray-600">Data inicial</label>
                                <input
                                    id="dp-inicio"
                                    type="date"
                            ...
                            <div>
                                <label for="dp-fim" class="block text-xs font-medium text-gray-600">Data final</label>
                                <input
                                    id="dp-fim"
                                    type="date"
                    ...
                    <section class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="dp-base" class="block text-xs font-medium text-gray-600">Base do relatório</label>
                                <select
                                    id="dp-base"
                                    wire:model.live="base"
                                    class="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-[#313e50] focus:outline-none focus:ring-1 focus:ring-[#313e50]"
                                >
                                    <option value="pago">Pagamentos realizados</option>
                                    <option value="competencia">Por competência</option>
                                    <option value="ambos">Pagos e por competência</option>
                                </select>
                            </div>
                            <div>
                                <label for="dp-agrupamento" class="block text-xs font-medium text-gray-600">Agrupamento</label>
                                <select
                                    id="dp-agrupamento"
                        ...
                        <label class="flex cursor-pointer items-center gap-2 text-sm text-gray-700">
                            ...
                            Incluir despesas canceladas no período
                        </label>
                    </section>
                    ...
                    <section class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="dp-detalhe" class="block text-xs font-medium text-gray-600">Detalhamento</label>
                                <select
                                    id="dp-detalhe"
                            ...
                            <div>
                                <label for="dp-formato" class="block text-xs font-medium text-gray-600">Formato de saída</label>
                                <select
                                    id="dp-formato"
