                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 py-3 text-center flex justify-center gap-2">
                                                ...
                                                @if($solicitacao->status === 'pendente')
                                                    <button type="button" wire:click="excluirSolicitacao({{ $solicitacao->id }})" wire:confirm="Deseja realmente cancelar esta solicitação de pagamento?" class="text-gray-400 hover:text-red-600 p-1 rounded hover:bg-red-50" title="Cancelar Solicitação">
