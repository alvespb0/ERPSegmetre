        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Cadastre as classificações de contas bancárias (ex.: Corrente, Poupança, Caixinha).
                </p>
            </div>
            <a
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-6 self-start">
                ...
                <div class="p-4 space-y-3">
                    <p class="text-xs text-gray-500 mb-4">
                        Revise a descrição antes de salvar. Este nome aparecerá como opção ao cadastrar novas contas bancárias.
                    </p>
