    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h1 class="text-2xl font-semibold text-gray-900">Nova Integração</h1>
                <p class="text-sm text-gray-500 mt-1">
                    Cadastre uma conexão com API externa, banco ou serviço fiscal.
                </p>
            </div>
            <a
        ...
        <form wire:submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input
                                type="text"
                                class="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#313e50] focus:border-[#313e50]"
                                placeholder="Ex.: Sicoob Cobrança"
                                wire:model="nome"
                            >
                        </div>
                        ...
                        @if ($autenticacao === 'outro')
                            <div class="md:col-span-2">
                                ...
                                <input
                                    type="text"
                                    class="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#313e50] focus:border-[#313e50]"
                                    placeholder="Descreva o método de autenticação"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea
                                rows="3"
                                class="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#313e50] focus:border-[#313e50]"
                                placeholder="Observações sobre o uso desta integração"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    @include('livewire.integracao.partials.campos-credenciais', ['modo' => 'create'])
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-6 self-start">
                ...
                <div class="p-3 space-y-2">
                    ...
                    >
                        <span wire:loading.remove wire:target="submit">Salvar Integração</span>
