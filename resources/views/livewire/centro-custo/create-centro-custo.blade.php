    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h1 class="text-2xl font-semibold text-gray-900">Novo Centro de Custo</h1>
                <p class="text-sm text-gray-500 mt-1">
                    Registre os centros de custo para melhor organização e categorização financeira da clínica.
                </p>
            </div>
            <a
                href=""
