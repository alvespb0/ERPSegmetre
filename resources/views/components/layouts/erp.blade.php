                    ...
                    <ul class="space-y-1">
                        ...
                        <li class="pt-4 pb-1" x-data="{ openCat: {{ request()->routeIs('erp.entidades.*') || request()->routeIs('erp.centro-custo.*') || request()->routeIs('erp.categoria-financeira.*') || request()->routeIs('erp.forma-pagamento.*') || request()->routeIs('erp.banco.*') || request()->routeIs('erp.tipo-conta.*') || request()->routeIs('erp.conta.*') || request()->routeIs('erp.usuarios.*') ? 'true' : 'false' }} }">
                            ...
                            <ul class="mt-1 space-y-1">
                                ...
                                <li x-data="{ openSub: {{ request()->routeIs('erp.forma-pagamento.*') ? 'true' : 'false' }} }">
                                    ...
                                    <ul x-show="openSub" x-collapse class="mt-1 space-y-1 pl-11">
                                        <li>
                                            <a href="{{route('erp.forma-pagamento.create')}}" class="block rounded-lg px-3 py-2 text-sm transition-all duration-200 {{ request()->routeIs('erp.forma-pagamento.create') ? 'text-white font-medium bg-white/10' : 'text-white/50 hover:bg-white/5 hover:text-white' }}">Nova Forma de Pag.</a>
                                        </li>
                                        <li>
                                            <a href="{{route('erp.forma-pagamento.index')}}" class="block rounded-lg px-3 py-2 text-sm transition-all duration-200 {{ request()->routeIs('erp.forma-pagamento.index') ? 'text-white font-medium bg-white/10' : 'text-white/50 hover:bg-white/5 hover:text-white' }}">Listar Formas de Pag.</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li x-data="{ openSub: {{ request()->routeIs('erp.banco.*') ? 'true' : 'false' }} }">
                                    ...
                                    <ul x-show="openSub" x-collapse class="mt-1 space-y-1 pl-11">
                                        <li>
                                            <a href="{{route('erp.banco.create')}}" class="block rounded-lg px-3 py-2 text-sm transition-all duration-200 {{ request()->routeIs('erp.banco.create') ? 'text-white font-medium bg-white/10' : 'text-white/50 hover:bg-white/5 hover:text-white' }}">Novo Banco</a>
                                        </li>
                                        <li>
                                            <a href="{{route('erp.banco.index')}}" class="block rounded-lg px-3 py-2 text-sm transition-all duration-200 {{ request()->routeIs('erp.banco.index') ? 'text-white font-medium bg-white/10' : 'text-white/50 hover:bg-white/5 hover:text-white' }}">Listar Bancos</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li x-data="{ openSub: {{ request()->routeIs('erp.tipo-conta.*') ? 'true' : 'false' }} }">
                                    ...
                                    <ul x-show="openSub" x-collapse class="mt-1 space-y-1 pl-11">
                                        <li>
                                            <a href="{{route('erp.tipo-conta.create')}}" class="block rounded-lg px-3 py-2 text-sm transition-all duration-200 {{ request()->routeIs('erp.tipo-conta.create') ? 'text-white font-medium bg-white/10' : 'text-white/50 hover:bg-white/5 hover:text-white' }}">Novo Tipo de Conta</a>
                                        </li>
                                        <li>
                                            <a href="{{route('erp.tipo-conta.index')}}" class="block rounded-lg px-3 py-2 text-sm transition-all duration-200 {{ request()->routeIs('erp.tipo-conta.index') ? 'text-white font-medium bg-white/10' : 'text-white/50 hover:bg-white/5 hover:text-white' }}">Listar Tipos de Conta</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="pt-4 pb-1" x-data="{ openCat: {{ request()->routeIs('erp.administracao.*') ? 'true' : 'false' }} }">
                            ...
                            <ul class="mt-1 space-y-1">
                                ...
                                <li>
                                    <a href="{{ route('erp.relatorios.index') }}" class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 {{ request()->routeIs('erp.relatorios.*') ? 'bg-white/10 text-white font-medium' : 'text-white/60 hover:bg-white/5 hover:text-white' }}">
                                        <span class="inline-flex h-5 w-5 items-center justify-center">
