<div
    ...
    role="dialog"
    aria-modal="true"
    aria-labelledby="fluxo-caixa-modal-titulo"
>
    <div
        ...
        >
            <header class="flex shrink-0 items-start justify-between gap-4 border-b border-gray-100 px-5 py-4 sm:px-6">
                <div>
                    ...
                    <h2 id="fluxo-caixa-modal-titulo" class="text-lg font-semibold text-gray-900">Fluxo de caixa — filtros de geração</h2>
                    <p class="mt-1 text-sm text-gray-500">Defina o período, o regime e a forma de agrupamento. A exportação será conectada na próxima etapa.</p>
                </div>
                <button
                    type="button"
                    wire:click="fechar"
                ...
                <div class="space-y-6">
                    <section class="space-y-3">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="fc-inicio" class="block text-xs font-medium text-gray-600">Data inicial</label>
                                <input
                                    id="fc-inicio"
                                    type="date"
                            ...
                            <div>
                                <label for="fc-fim" class="block text-xs font-medium text-gray-600">Data final</label>
                                <input
                                    id="fc-fim"
                                    type="date"
                    ...
                    <section class="space-y-3">
                        <h3 class="text-xs font-semibold uppercase tracking-wide text-gray-400">Movimentação</h3>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="fc-regime" class="block text-xs font-medium text-gray-600">Regime</label>
                                <select
                                    id="fc-regime"
                                    wire:model.live="regime"
                                    class="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-[#313e50] focus:outline-none focus:ring-1 focus:ring-[#313e50]"
                                >
                                    <option value="realizado">Realizado (pagos e recebidos)</option>
                                    <option value="previsto">Previsto (em aberto no período)</option>
                                    <option value="ambos">Realizado + previsto</option>
                                </select>
                            </div>
                            <div>
                                <label for="fc-agrupamento" class="block text-xs font-medium text-gray-600">Agrupamento</label>
                                <select
                                    id="fc-agrupamento"
                        ...
                        <div class="space-y-2">
                            <label class="flex cursor-pointer items-center gap-2 text-sm text-gray-700">
                                <input type="checkbox" wire:model.live="incluirSaldoInicial" class="rounded border-gray-300 text-[#313e50] focus:ring-[#313e50]">
                                Incluir saldo inicial do período
                            </label>
                            <label class="flex cursor-pointer items-center gap-2 text-sm text-gray-700">
                                <input type="checkbox" wire:model.live="incluirProjecao" class="rounded border-gray-300 text-[#313e50] focus:ring-[#313e50]">
                                Incluir projeção de saldo ao final do período
                            </label>
                        </div>
                    </section>
                    ...
                    <section class="space-y-3">
                        ...
                        <div>
                            <label for="fc-formato" class="block text-xs font-medium text-gray-600">Formato de saída</label>
                            <select
                                id="fc-formato"
                                wire:model.live="formatoSaida"
                                class="mt-1 w-full max-w-xs rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-[#313e50] focus:outline-none focus:ring-1 focus:ring-[#313e50]"
                            >
